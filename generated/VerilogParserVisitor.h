...
public:
   ...
   */
    ...
    virtual std::any visitDiscipline_declaration(VerilogParser::Discipline_declarationContext *context) = 0;

    virtual std::any visitDiscipline_name(VerilogParser::Discipline_nameContext *context) = 0;

    virtual std::any visitDiscipline_item(VerilogParser::Discipline_itemContext *context) = 0;

    virtual std::any visitDomain_statement(VerilogParser::Domain_statementContext *context) = 0;

    virtual std::any visitPotential_declaration(VerilogParser::Potential_declarationContext *context) = 0;

    virtual std::any visitFlow_declaration(VerilogParser::Flow_declarationContext *context) = 0;

    virtual std::any visitNature_declaration(VerilogParser::Nature_declarationContext *context) = 0;

    virtual std::any visitNature_item(VerilogParser::Nature_itemContext *context) = 0;

    virtual std::any visitAccess_spec(VerilogParser::Access_specContext *context) = 0;
    ...
    virtual std::any visitElectrical_declaration(VerilogParser::Electrical_declarationContext *context) = 0;
    ...
    virtual std::any visitAnalog_construct(VerilogParser::Analog_constructContext *context) = 0;
    ...
    virtual std::any visitAnalog_assignment(VerilogParser::Analog_assignmentContext *context) = 0;
    ...
    virtual std::any visitUnit_number(VerilogParser::Unit_numberContext *context) = 0;
