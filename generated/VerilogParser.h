...
public:
  ...
  enum {
    ...
    RuleModule_keyword = 9, RuleDiscipline_declaration = 10, RuleDiscipline_name = 11, 
    RuleDiscipline_item = 12, RuleDomain_statement = 13, RulePotential_declaration = 14, 
    RuleFlow_declaration = 15, RuleNature_declaration = 16, RuleNature_item = 17, 
    RuleAccess_spec = 18, RuleModule_parameter_port_list = 19, RuleList_of_port_declarations = 20, 
    RulePort = 21, RulePort_implicit = 22, RulePort_explicit = 23, RulePort_expression = 24, 
    RulePort_reference = 25, RulePort_declaration = 26, RuleModule_item = 27, 
    RuleModule_or_generate_item = 28, RuleModule_or_generate_item_declaration = 29, 
    RuleParameter_override = 30, RuleConfig_declaration = 31, RuleDesign_statement = 32, 
    RuleDesign_statement_item = 33, RuleConfig_rule_statement = 34, RuleDefault_clause = 35, 
    RuleInst_clause = 36, RuleInst_name = 37, RuleCell_clause = 38, RuleLiblist_clause = 39, 
    RuleUse_clause = 40, RuleLocal_parameter_declaration = 41, RuleParameter_declaration = 42, 
    RuleSpecparam_declaration = 43, RuleParameter_type = 44, RuleInout_declaration = 45, 
    RuleInput_declaration = 46, RuleOutput_declaration = 47, RuleEvent_declaration = 48, 
    RuleInteger_declaration = 49, RuleNet_declaration = 50, RuleReal_declaration = 51, 
    RuleRealtime_declaration = 52, RuleReg_declaration = 53, RuleTime_declaration = 54, 
    RuleNet_type = 55, RuleElectrical_declaration = 56, RuleOutput_variable_type = 57, 
    RuleReal_type = 58, RuleVariable_type = 59, RuleDrive_strength = 60, 
    RuleStrength0 = 61, RuleStrength1 = 62, RuleCharge_strength = 63, RuleDelay3 = 64, 
    RuleDelay2 = 65, RuleDelay_value = 66, RuleList_of_defparam_assignments = 67, 
    RuleList_of_event_identifiers = 68, RuleEvent_id = 69, RuleList_of_net_decl_assignments = 70, 
    RuleList_of_net_identifiers = 71, RuleNet_id = 72, RuleList_of_param_assignments = 73, 
    RuleList_of_port_identifiers = 74, RuleList_of_real_identifiers = 75, 
    RuleList_of_specparam_assignments = 76, RuleList_of_variable_identifiers = 77, 
    RuleList_of_variable_port_identifiers = 78, RuleVar_port_id = 79, RuleDefparam_assignment = 80, 
    RuleNet_decl_assignment = 81, RuleParam_assignment = 82, RuleSpecparam_assignment = 83, 
    RulePulse_control_specparam = 84, RuleError_limit_value = 85, RuleReject_limit_value = 86, 
    RuleLimit_value = 87, RuleDimension = 88, RuleRange_ = 89, RuleFunction_declaration = 90, 
    RuleFunction_item_declaration = 91, RuleFunction_port_list = 92, RuleFunc_port_item = 93, 
    RuleFunction_range_or_type = 94, RuleTask_declaration = 95, RuleTask_item_declaration = 96, 
    RuleTask_port_list = 97, RuleTask_port_item = 98, RuleTf_input_declaration = 99, 
    RuleTf_output_declaration = 100, RuleTf_inout_declaration = 101, RuleTask_port_type = 102, 
    RuleBlock_item_declaration = 103, RuleList_of_block_variable_identifiers = 104, 
    RuleList_of_block_real_identifiers = 105, RuleBlock_variable_type = 106, 
    RuleBlock_real_type = 107, RuleGate_instantiation = 108, RuleCmos_switch_instance = 109, 
    RuleEnable_gate_instance = 110, RuleMos_switch_instance = 111, RuleN_input_gate_instance = 112, 
    RuleN_output_gate_instance = 113, RulePass_switch_instance = 114, RulePass_enable_switch_instance = 115, 
    RulePull_gate_instance = 116, RuleName_of_gate_instance = 117, RulePulldown_strength = 118, 
    RulePullup_strength = 119, RuleEnable_terminal = 120, RuleInout_terminal = 121, 
    RuleInput_terminal = 122, RuleNcontrol_terminal = 123, RuleOutput_terminal = 124, 
    RulePcontrol_terminal = 125, RuleCmos_switchtype = 126, RuleEnable_gatetype = 127, 
    RuleMos_switchtype = 128, RuleN_input_gatetype = 129, RuleN_output_gatetype = 130, 
    RulePass_en_switchtype = 131, RulePass_switchtype = 132, RuleModule_instantiation = 133, 
    RuleParameter_value_assignment = 134, RuleList_of_parameter_assignments = 135, 
    RuleOrdered_parameter_assignment = 136, RuleNamed_parameter_assignment = 137, 
    RuleModule_instance = 138, RuleName_of_module_instance = 139, RuleList_of_port_connections = 140, 
    RuleOrdered_port_connection = 141, RuleNamed_port_connection = 142, 
    RuleGenerate_region = 143, RuleGenvar_declaration = 144, RuleList_of_genvar_identifiers = 145, 
    RuleLoop_generate_construct = 146, RuleGenvar_initialization = 147, 
    RuleGenvar_expression = 148, RuleGenvar_iteration = 149, RuleConditional_generate_construct = 150, 
    RuleIf_generate_construct = 151, RuleCase_generate_construct = 152, 
    RuleCase_generate_item = 153, RuleGenerate_block = 154, RuleGenerate_block_name = 155, 
    RuleGenerate_block_or_null = 156, RuleUdp_declaration = 157, RuleUdp_port_list = 158, 
    RuleUdp_declaration_port_list = 159, RuleUdp_port_declaration = 160, 
    RuleUdp_output_declaration = 161, RuleUdp_input_declaration = 162, RuleUdp_reg_declaration = 163, 
    RuleUdp_body = 164, RuleCombinational_body = 165, RuleCombinational_entry = 166, 
    RuleSequential_body = 167, RuleUdp_initial_statement = 168, RuleInit_val = 169, 
    RuleSequential_entry = 170, RuleSeq_input_list = 171, RuleLevel_input_list = 172, 
    RuleEdge_input_list = 173, RuleEdge_indicator = 174, RuleCurrent_state = 175, 
    RuleNext_state = 176, RuleOutput_symbol = 177, RuleLevel_symbol = 178, 
    RuleEdge_symbol = 179, RuleUdp_instantiation = 180, RuleUdp_instance = 181, 
    RuleName_of_udp_instance = 182, RuleContinuous_assign = 183, RuleList_of_net_assignments = 184, 
    RuleNet_assignment = 185, RuleInitial_construct = 186, RuleAlways_construct = 187, 
    RuleAnalog_construct = 188, RuleBlocking_assignment = 189, RuleNonblocking_assignment = 190, 
    RuleAnalog_assignment = 191, RuleProcedural_continuous_assignments = 192, 
    RuleVariable_assignment = 193, RulePar_block = 194, RuleBlock_name = 195, 
    RuleSeq_block = 196, RuleStatement = 197, RuleStatement_or_null = 198, 
    RuleFunction_statement = 199, RuleDelay_control = 200, RuleDelay_or_event_control = 201, 
    RuleDisable_statement = 202, RuleEvent_control = 203, RuleEvent_trigger = 204, 
    RuleEvent_expression = 205, RuleProcedural_timing_control = 206, RuleProcedural_timing_control_statement = 207, 
    RuleWait_statement = 208, RuleConditional_statement = 209, RuleCase_statement = 210, 
    RuleCase_item = 211, RuleLoop_statement = 212, RuleSystem_task_enable = 213, 
    RuleSys_task_en_port_list = 214, RuleSys_task_en_port_item = 215, RuleTask_enable = 216, 
    RuleTask_en_port_list = 217, RuleSpecify_block = 218, RuleSpecify_item = 219, 
    RulePulsestyle_declaration = 220, RuleShowcancelled_declaration = 221, 
    RulePath_declaration = 222, RuleSimple_path_declaration = 223, RuleParallel_path_description = 224, 
    RuleFull_path_description = 225, RuleList_of_path_inputs = 226, RuleList_of_path_outputs = 227, 
    RuleSpecify_input_terminal_descriptor = 228, RuleSpecify_output_terminal_descriptor = 229, 
    RuleInput_identifier = 230, RuleOutput_identifier = 231, RulePath_delay_value = 232, 
    RuleList_of_path_delay_expressions = 233, RuleT_path_delay_expression = 234, 
    RuleTrise_path_delay_expression = 235, RuleTfall_path_delay_expression = 236, 
    RuleTz_path_delay_expression = 237, RuleT01_path_delay_expression = 238, 
    RuleT10_path_delay_expression = 239, RuleT0z_path_delay_expression = 240, 
    RuleTz1_path_delay_expression = 241, RuleT1z_path_delay_expression = 242, 
    RuleTz0_path_delay_expression = 243, RuleT0x_path_delay_expression = 244, 
    RuleTx1_path_delay_expression = 245, RuleT1x_path_delay_expression = 246, 
    RuleTx0_path_delay_expression = 247, RuleTxz_path_delay_expression = 248, 
    RuleTzx_path_delay_expression = 249, RulePath_delay_expression = 250, 
    RuleEdge_sensitive_path_declaration = 251, RuleParallel_edge_sensitive_path_description = 252, 
    RuleFull_edge_sensitive_path_description = 253, RuleData_source_expression = 254, 
    RuleEdge_identifier = 255, RuleState_dependent_path_declaration = 256, 
    RulePolarity_operator = 257, RuleSystem_timing_check = 258, RuleSetup_timing_check = 259, 
    RuleNotifier_opt = 260, RuleHold_timing_check = 261, RuleSetuphold_timing_check = 262, 
    RuleTiming_check_opt = 263, RuleStamptime_cond_opt = 264, RuleChecktime_cond_opt = 265, 
    RuleDelayed_ref_opt = 266, RuleDelayed_data_opt = 267, RuleRecovery_timing_check = 268, 
    RuleRemoval_timing_check = 269, RuleRecrem_timing_check = 270, RuleSkew_timing_check = 271, 
    RuleTimeskew_timing_check = 272, RuleSkew_timing_check_opt = 273, RuleEvent_based_flag_opt = 274, 
    RuleRemain_active_flag_opt = 275, RuleFullskew_timing_check = 276, RulePeriod_timing_check = 277, 
    RuleWidth_timing_check = 278, RuleThreshold_opt = 279, RuleNochange_timing_check = 280, 
    RuleChecktime_condition = 281, RuleControlled_reference_event = 282, 
    RuleData_event = 283, RuleDelayed_data = 284, RuleDelayed_reference = 285, 
    RuleEnd_edge_offset = 286, RuleEvent_based_flag = 287, RuleNotifier = 288, 
    RuleReference_event = 289, RuleRemain_active_flag = 290, RuleStamptime_condition = 291, 
    RuleStart_edge_offset = 292, RuleThreshold = 293, RuleTiming_check_limit = 294, 
    RuleTiming_check_event = 295, RuleControlled_timing_check_event = 296, 
    RuleTiming_check_event_control = 297, RuleSpecify_terminal_descriptor = 298, 
    RuleEdge_control_specifier = 299, RuleEdge_descriptor = 300, RuleTiming_check_condition = 301, 
    RuleScalar_timing_check_condition = 302, RuleScalar_constant = 303, 
    RuleConcatenation = 304, RuleConstant_concatenation = 305, RuleConstant_multiple_concatenation = 306, 
    RuleModule_path_concatenation = 307, RuleModule_path_multiple_concatenation = 308, 
    RuleMultiple_concatenation = 309, RuleConstant_function_call = 310, 
    RuleConstant_system_function_call = 311, RuleFunction_call = 312, RuleSystem_function_call = 313, 
    RuleSys_func_call_port_list = 314, RuleBase_expression = 315, RuleConstant_base_expression = 316, 
    RuleConstant_expression = 317, RuleConstant_mintypmax_expression = 318, 
    RuleConstant_range_expression = 319, RuleDimension_constant_expression = 320, 
    RuleExpression = 321, RuleLsb_constant_expression = 322, RuleMintypmax_expression = 323, 
    RuleModule_path_expression = 324, RuleModule_path_mintypmax_expression = 325, 
    RuleMsb_constant_expression = 326, RuleRange_expression = 327, RuleWidth_constant_expression = 328, 
    RuleConstant_primary = 329, RuleModule_path_primary = 330, RulePrimary = 331, 
    RuleSelect_ = 332, RuleBit_select = 333, RuleNet_lvalue = 334, RuleConst_select = 335, 
    RuleConst_bit_select = 336, RuleVariable_lvalue = 337, RuleUnary_operator = 338, 
    RuleUnary_module_path_operator = 339, RuleNumber = 340, RuleReal_number = 341, 
    RuleDecimal_number = 342, RuleBinary_number = 343, RuleOctal_number = 344, 
    RuleHex_number = 345, RuleSize = 346, RuleFixed_point_number = 347, 
    RuleUnit_number = 348, RuleExponential_number = 349, RuleUnsigned_number = 350, 
    RuleDecimal_value = 351, RuleBinary_value = 352, RuleOctal_value = 353, 
    RuleHex_value = 354, RuleDecimal_base = 355, RuleBinary_base = 356, 
    RuleOctal_base = 357, RuleHex_base = 358, RuleString_ = 359, RuleAttribute_instance = 360, 
    RuleAttr_spec = 361, RuleAttr_name = 362, RuleBlock_identifier = 363, 
    RuleCell_identifier = 364, RuleConfig_identifier = 365, RuleEscaped_identifier = 366, 
    RuleEvent_identifier = 367, RuleFunction_identifier = 368, RuleGate_instance_identifier = 369, 
    RuleGenerate_block_identifier = 370, RuleGenvar_identifier = 371, RuleHierarchical_identifier = 372, 
    RuleHier_ref = 373, RuleIdentifier = 374, RuleInput_port_identifier = 375, 
    RuleInstance_identifier = 376, RuleLibrary_identifier = 377, RuleModule_identifier = 378, 
    RuleModule_instance_identifier = 379, RuleNet_identifier = 380, RuleOutput_port_identifier = 381, 
    RuleParameter_identifier = 382, RulePort_identifier = 383, RuleReal_identifier = 384, 
    RuleSimple_identifier = 385, RuleSpecparam_identifier = 386, RuleSystem_function_identifier = 387, 
    RuleSystem_task_identifier = 388, RuleTask_identifier = 389, RuleTerminal_identifier = 390, 
    RuleTopmodule_identifier = 391, RuleUdp_identifier = 392, RuleUdp_instance_identifier = 393, 
    RuleVariable_identifier = 394
  };
  ...
  class Discipline_declarationContext;
  class Discipline_nameContext;
  class Discipline_itemContext;
  class Domain_statementContext;
  class Potential_declarationContext;
  class Flow_declarationContext;
  class Nature_declarationContext;
  class Nature_itemContext;
  ...
  class Electrical_declarationContext;
  ...
  public:
    ...
    Discipline_declarationContext *discipline_declaration();
  ...
  class  Discipline_declarationContext : public antlr4::ParserRuleContext {
  public:
    Discipline_declarationContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DISCIPLINE();
    Discipline_nameContext *discipline_name();
    antlr4::tree::TerminalNode *SC();
    antlr4::tree::TerminalNode *ENDDISCIPLINE();
    std::vector<Discipline_itemContext *> discipline_item();
    Discipline_itemContext* discipline_item(size_t i);
  ...
  class  Discipline_nameContext : public antlr4::ParserRuleContext {
  public:
    Discipline_nameContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IdentifierContext *identifier();
    antlr4::tree::TerminalNode *ELECTRICAL();
    antlr4::tree::TerminalNode *VOLTAGE();
  ...
  class  Discipline_itemContext : public antlr4::ParserRuleContext {
  public:
    Discipline_itemContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Domain_statementContext *domain_statement();
    Potential_declarationContext *potential_declaration();
  ...
  Discipline_itemContext* discipline_item();

  class  Domain_statementContext : public antlr4::ParserRuleContext {
  public:
    Domain_statementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DOMAIN();
    IdentifierContext *identifier();
    antlr4::tree::TerminalNode *SC();
  ...
  class  Potential_declarationContext : public antlr4::ParserRuleContext {
  public:
    Potential_declarationContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    IdentifierContext *identifier();
    antlr4::tree::TerminalNode *SC();
    antlr4::tree::TerminalNode *ENDNATURE();
    std::vector<Nature_itemContext *> nature_item();
    Nature_itemContext* nature_item(size_t i);
  ...
  class  Nature_itemContext : public antlr4::ParserRuleContext {
  public:
    Nature_itemContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ...
    antlr4::tree::TerminalNode *IDT_NATURE();
    IdentifierContext *identifier();
    antlr4::tree::TerminalNode *DDT_NATURE();
    antlr4::tree::TerminalNode *ABSTOL();
  ...
  Nature_itemContext* nature_item();
  ...
  public:
    ...
    Electrical_declarationContext *electrical_declaration();
  ...
  public:
    ...
    Analog_constructContext *analog_construct();
  ...
  class  Electrical_declarationContext : public antlr4::ParserRuleContext {
  public:
    Electrical_declarationContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ELECTRICAL();
    List_of_port_identifiersContext *list_of_port_identifiers();
    antlr4::tree::TerminalNode *SC();
  ...
  class  Analog_constructContext : public antlr4::ParserRuleContext {
  public:
    Analog_constructContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ANALOG();
    StatementContext *statement();
  ...
  class  Analog_assignmentContext : public antlr4::ParserRuleContext {
  public:
    Analog_assignmentContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Function_callContext *function_call();
    antlr4::tree::TerminalNode *LTPL();
    ExpressionContext *expression();
    Delay_or_event_controlContext *delay_or_event_control();
  ...
  Analog_assignmentContext* analog_assignment();
  ...
  public:
    ...
    Unit_numberContext *unit_number();
  ...
  class  Unit_numberContext : public antlr4::ParserRuleContext {
  public:
    Unit_numberContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *UNIT_NUMBER();
