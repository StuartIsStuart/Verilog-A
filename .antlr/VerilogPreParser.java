// Generated from c:/Users/Stuart/Documents/VA/VerilogPreParser.g4 by ANTLR 4.13.1
...
public class VerilogPreParser extends Parser {
	...
	public final Macro_textContext macro_text() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 199)) & ~0x3f) == 0 && ((1L << (_la - 199)) & 4260607557633L) != 0)) {
				{
				setState(227);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final Pragma_directiveContext pragma_directive() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 166)) & ~0x3f) == 0 && ((1L << (_la - 166)) & 47244640257L) != 0)) {
				{
				setState(244);
				pragma_expression();
				setState(249);
