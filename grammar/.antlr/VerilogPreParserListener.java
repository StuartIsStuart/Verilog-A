...
public interface VerilogPreParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link VerilogPreParser#macro_text_}.
	 * @param ctx the parse tree
	 */
	void enterMacro_text_(VerilogPreParser.Macro_text_Context ctx);
	/**
	 * Exit a parse tree produced by {@link VerilogPreParser#macro_text_}.
	 * @param ctx the parse tree
	 */
	void exitMacro_text_(VerilogPreParser.Macro_text_Context ctx);
	/**
